...
def main ():
    ...
    Command line
    ------------
    For non-slab calculations, a user must specify either line geometry or 
    plane geometry, although plane geometry is limited to XY, YZ, and XZ planes.
    ...
    to make decisions for the resulting plot.
    """
